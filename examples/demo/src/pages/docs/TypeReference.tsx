      ...
      <section className="space-y-6">
        ...
        <div className="bg-gray-950 rounded-2xl p-8 font-mono text-xs overflow-x-auto shadow-2xl ring-1 ring-white/10">
          <pre className="space-y-2 text-gray-400">
            ...
            <div className="pl-4"><span className="text-indigo-400">validationMode</span><span className="text-emerald-400">?</span><span className="text-emerald-400">:</span> <span className="text-amber-400">'onChange'</span> <span className="text-emerald-400">|</span> <span className="text-amber-400">'onStepChange'</span> <span className="text-emerald-400">|</span> <span className="text-amber-400">'manual'</span><span className="text-emerald-400">;</span></div>
            <div className="pl-4"><span className="text-indigo-400">autoValidate</span><span className="text-emerald-400">?</span><span className="text-emerald-400">:</span> <span className="text-rose-400">boolean</span><span className="text-emerald-400">;</span> <span className="text-gray-500">// [DEPRECATED] Use validationMode</span></div>
      ...
      <section className="space-y-6">
        ...
        <div className="bg-gray-950 rounded-2xl p-8 font-mono text-xs overflow-x-auto shadow-2xl ring-1 ring-white/10">
          <pre className="space-y-2 text-gray-400">
            ...
            <div className="pl-4"><span className="text-indigo-400">validationMode</span><span className="text-emerald-400">?</span><span className="text-emerald-400">:</span> <span className="text-amber-400">ValidationMode</span><span className="text-emerald-400">;</span> <span className="text-gray-500">// Global default</span></div>
            <div className="pl-4"><span className="text-indigo-400">autoValidate</span><span className="text-emerald-400">?</span><span className="text-emerald-400">:</span> <span className="text-rose-400">boolean</span><span className="text-emerald-400">;</span> <span className="text-gray-500">// [DEPRECATED]</span></div>
